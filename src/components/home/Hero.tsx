        ...
        <section className="max-w-[1400px] mx-auto px-6 py-12 flex flex-col gap-12">
            ...
            <div className="relative w-full max-w-[1320px] h-[750px] mx-auto bg-[#707070] rounded-[48px] overflow-hidden group">
                ...
                <div className="absolute left-0 top-22">
                    <div className="bg-[#232321] text-white px-3 py-8 rounded-tl-[12px] rounded-bl-[12px] text-[12px] font-bold uppercase tracking-[0.2em] [writing-mode:vertical-lr] rotate-180 flex items-center justify-center">
                ...
                <div className="absolute left-24 bottom-24 flex flex-col gap-4 text-white z-10">
                    ...
                    <button className="bg-[#437EF7] hover:bg-[#3b6ed3] transition-colors text-white px-8 py-4 rounded-xl font-semibold uppercase w-fit text-sm mt-4">
                        Shop Now
                    </button>
                </div>
